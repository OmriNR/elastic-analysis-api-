...
public interface IUsersService
{
    ...
    void SetAdmin(string requested, string asked, out Statuses status, out string error);
    void SetActive(string requested, string asked, out Statuses status, out string error);
